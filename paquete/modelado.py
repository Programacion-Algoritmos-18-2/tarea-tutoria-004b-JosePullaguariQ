#Creamos la clase object Persona
class Persona(object):
	...
	def obtener_edad(self):
		return self.edad
	#Metodo que presentamos datos
	def presentar_datos(self):
		c="%s-%s"%(self.obtener_edad(),self.nombres)
		return c

#Creamos la clase Estudiante con herencia de Persona
class Estudiante(Persona):
	...
	def obtener_nota(self):
		return nota
	#Metodo para presentar datos con herencia
	def presentar_datos(self):
